"""
Module 01: RAG Fundamentals (Debuggable Python Script)
=====================================================
This script mirrors the workflow from 01_RAG_Fundamentals.ipynb.
...
# %% [3] Stage 2: EMBED + STORE — Create embeddings and store in vector DB
